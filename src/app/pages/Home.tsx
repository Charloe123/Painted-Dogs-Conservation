...
const newsItems = [
  {
    image: 'https://res.cloudinary.com/dpahyb1x9/image/upload/v1778578010/image-asset_19_fkyith.jpg',
  ...
  {
    image: 'https://res.cloudinary.com/dpahyb1x9/image/upload/v1778577983/DSCN0016_tnjjac.jpg',
  ...
  {
    image: 'https://res.cloudinary.com/dpahyb1x9/image/upload/v1778577948/image-asset_13_ioffaj.jpg',
    ...
    <div>
      ...
      <section className="relative h-[85vh] min-h-[500px] overflow-hidden">
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 text-white/60 flex flex-col items-center gap-2">
          ...
          <div className="w-0.5 h-8 bg-white/30 relative overflow-hidden">
            <motion.div
              className="absolute top-0 w-full bg-[#ef702a]"
              animate={{ y: ['-100%', '100%'] }}
        ...
        <div className="relative z-10 flex items-center h-full">
          <div className="container mx-auto px-6">
            ...
            >
              <div className="inline-flex items-center gap-2 bg-[#ef702a]/20 border border-[#ef702a]/40 text-[#ef702a] px-4 py-1.5 rounded-full text-sm font-medium mb-6">
                <span className="w-2 h-2 bg-[#ef702a] rounded-full animate-pulse" />
                Zimbabwe's Most Endangered Carnivore
              </div>
              <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
                Save the<br />
                <span className="text-[#ef702a]">Painted Dog</span>
              </h1>
              ...
              <div className="flex flex-wrap gap-4">
                <Link
                  to="/donate"
                  className="bg-[#ef702a] px-8 py-4 rounded-full text-lg font-semibold hover:bg-[#ff6600] transition-all hover:scale-105 shadow-xl shadow-[#ef702a]/30"
                >
                  Support Our Mission
                </Link>
                <Link
                  to="/about-painted-dogs"
                  className="border-2 border-white/50 px-8 py-4 rounded-full text-lg font-semibold hover:bg-white hover:text-black transition-all"
                >
                  Learn More
                </Link>
              </div>
      ...
      <section className="container mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-black mb-3">Our Conservation Work</h2>
          <p className="text-[#974d4a] max-w-xl mx-auto">Three decades of protecting Africa's most endangered carnivore through science, community, and education.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-5 auto-rows-[220px]">
          ...
          <motion.div
            ...
            className="md:col-span-2 md:row-span-2 bg-black rounded-3xl p-8 text-white relative overflow-hidden group cursor-pointer"
          >
            <div className="relative z-10 h-full flex flex-col justify-between">
              ...
              <Link
                to="/who-we-are"
                className="inline-flex items-center gap-2 bg-[#ef702a] text-white px-6 py-3 rounded-full font-semibold hover:bg-[#ff6600] transition-all w-fit"
              >
                Our Story <ArrowRight className="w-4 h-4" />
              </Link>
            </div>
            <div className="absolute bottom-0 right-0 w-72 h-72 bg-[#ef702a] rounded-full -mr-36 -mb-36 opacity-10 group-hover:scale-110 transition-transform duration-500" />
          </motion.div>
          ...
          <motion.div whileHover={{ scale: 1.02 }} className="md:col-span-2 rounded-3xl overflow-hidden relative group cursor-pointer">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-end p-6">
              <div className="text-white">
                <div className="text-xs text-[#ef702a] font-semibold uppercase tracking-wider mb-1">Pack Behavior</div>
          ...
          <motion.div whileHover={{ scale: 1.02 }} className="md:col-span-2 rounded-3xl overflow-hidden relative group cursor-pointer">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/30 to-transparent flex flex-col justify-end p-6 text-white">
              <div className="text-xs text-[#ef702a] font-semibold uppercase tracking-wider mb-1">Field Research</div>
              ...
              <Link
                ...
                className="self-start bg-[#ef702a] px-5 py-2 rounded-full text-sm font-semibold hover:bg-[#ff6600] transition-all"
              >
                View Programs
              </Link>
            </div>
      ...
      <section className="bg-black py-16">
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-12">
            ...
            <Link to="/conservation-programs" className="border border-[#ef702a] text-[#ef702a] px-6 py-3 rounded-full text-sm font-semibold hover:bg-[#ef702a] hover:text-white transition-all">
              View All Programs
            </Link>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { icon: Shield, title: 'Anti-Poaching', desc: 'Community scouts patrol key corridors 24/7, protecting painted dogs and other wildlife from snares and poaching.', color: '#ef702a' },
              { icon: Camera, title: 'Research & Tracking', desc: 'GPS collars and camera traps provide crucial data on pack movements, territories, and breeding success.', color: '#974d4a' },
              { icon: Globe, title: 'Community Education', desc: 'Our education centre visits schools, engaging the next generation of conservation champions.', color: '#ff6600' },
            ].map(({ icon: Icon, title, desc, color }, i) => (
              <motion.div
                key={i}
                whileHover={{ y: -4 }}
                className="bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-[#ef702a]/40 transition-all"
              >
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-12">
            <div>
              <h2 className="text-4xl font-bold text-black mb-2">Latest News</h2>
              <p className="text-[#974d4a]">Stories from the field</p>
            </div>
            <Link to="/blog" className="border border-[#ef702a] text-[#ef702a] px-6 py-3 rounded-full text-sm font-semibold hover:bg-[#ef702a] hover:text-white transition-all">
              View All Posts
            </Link>
          </div>
              ...
              >
                <div className="h-52 overflow-hidden relative">
                  <ImageWithFallback
                    ...
                    className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700"
                  />
                  <div className="absolute top-4 left-4 bg-[#ef702a] text-white text-xs font-semibold px-3 py-1 rounded-full">
                    {item.category}
                  </div>
                </div>
                <div className="p-6">
                  <p className="text-[#ff6600] text-xs mb-2 flex items-center gap-1">
                    <Star className="w-3 h-3 text-[#ef702a]" /> {item.date}
                  </p>
                  <h3 className="text-lg font-bold text-black mb-2 leading-tight">{item.title}</h3>
                  <p className="text-[#974d4a] text-sm leading-relaxed mb-4">{item.excerpt}</p>
                  <Link to="/blog" className="text-[#ef702a] font-semibold text-sm hover:text-[#ff6600] transition-colors inline-flex items-center gap-1">
      ...
      {/* CTA Banner */}
      <section className="bg-[#ef702a] py-16">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link to="/donate" className="bg-white text-[#ef702a] px-8 py-4 rounded-full font-bold hover:bg-black transition-all text-lg hover:scale-105">
              Donate Today
            </Link>
            <Link to="/conservation-programs" className="border-2 border-white text-white px-8 py-4 rounded-full font-bold hover:bg-white hover:text-[#ef702a] transition-all text-lg">
              Our Programs
            </Link>
          </div>
        </div>
